...
public class ItemStacks {
    ...
    public static final ItemStack bootsPearl = new ItemStack(ModArmor.bootsPearl, 1, 0);
    public static final ItemStack helmetBlackPearl = new ItemStack(ModArmor.helmetBlackPearl, 1, 0);
    public static final ItemStack chestplateBlackPearl = new ItemStack(ModArmor.chestplateBlackPearl, 1, 0);
    public static final ItemStack leggingsBlackPearl = new ItemStack(ModArmor.leggingsBlackPearl, 1, 0);
    public static final ItemStack bootsBlackPearl = new ItemStack(ModArmor.bootsBlackPearl, 1, 0);
    public static final ItemStack crownShell = new ItemStack(ModArmor.crownShell, 1, 0);
